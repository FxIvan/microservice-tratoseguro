...
func main() {
	...
	mongoURI := flag.String("mongoURI", fmt.Sprintf("mongodb://%s:%s@host.docker.internal:%d/%s?authSource=admin", mongo_user, mongo_password, 27017, "media"), "Mongo Connection Uri")
